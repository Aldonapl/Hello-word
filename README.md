...
3.Branch for work and merge via pull requests. Do day-to-day development on short-lived branches and merge back through a PR to enable discussion and review.
4.Protect your main branch. Require pull requests (PRs), passing status checks, and reviews before merging into main to reduce accidental breakage.
5.Run automated checks on every change. Attach tests, linting, and security checks to PRs so problems are caught before merging.
6.Document your workflow. Write down how your team branches, reviews, merges, and releases so contributors follow the same rules.
